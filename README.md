...
Download the `agent-ingest-audit-optimize-0.6.0-skill.zip` release asset and install its single top-level Skill directory according to the client's documentation.
