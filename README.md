...
Download the `agent-ingest-audit-optimize-0.2.3-skill.zip` release asset and install its single top-level Skill directory according to the client's documentation.
