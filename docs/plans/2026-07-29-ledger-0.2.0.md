...
- Follow the existing repository pattern of a hand-written validator plus a published JSON Schema, with a test asserting the two agree (see `evals/scripts/eval_suite.py` and `evals/result.schema.json`).
